...
```bash cURL
curl -X POST "https://app.autocalls.ai/api/user/conversations/7c9e6679-7425-40de-944b-e07fc1f90ae7/disable-ai" \
...
const response = await fetch(
  `https://app.autocalls.ai/api/user/conversations/${conversationId}/disable-ai`,
  {
    method: 'POST',
    headers: {
...
response = requests.post(
    f'https://app.autocalls.ai/api/user/conversations/{conversation_id}/disable-ai',
