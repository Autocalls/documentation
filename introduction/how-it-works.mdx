...
description: "Understand the technical flow of how SpotzyAI processes and handles phone conversations using AI"
---

SpotzyAI blends **AI voice recognition** with **LLM-based replies** to conduct live phone conversations. Below is a simplified flow:
