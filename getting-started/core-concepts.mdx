...
title: "Core Concepts"
icon: "lightbulb"
description: "Learn the fundamental building blocks of SpotzyAI, including system prompts, voices, and AI assistants"
---

Welcome to the fundamentals of SpotzyAI. Here, we explore the essential building blocks that you need to understand before configuring your AI assistant and calls.
...
- SpotzyAI integrates with **ElevenLabs** voices for natural-sounding speech.
